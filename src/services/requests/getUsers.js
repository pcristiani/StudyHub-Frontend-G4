...
export const getUsers = async (idUsuario, jwtUser) => {
    ...
    data.map(info => {
        if (info.id === idUsuario) {
            ...
            // console.log('usuariso: ', usuario[0]);
        }
    });
...
export const updateValidarEstudiante = async (idUsuario) => {
    ...
    console.log('resulsssssssst: ', idUsuario);
    ...
    try {
        ...
        // Podrías manejar el error de manera más específica o lanzar una excepción personalizada
        throw error;
    }
}
