...
const TriggerButton = styled('button')(
  ...
  cursor: pointer;
  background: ${theme.palette.mode === 'dark' ? grey[900] : '#575757'};
...
const SnackbarContent = styled('div')(
  ...
  gap: 8px;
  overflow: hidden;
  background-color: ${theme.palette.mode === 'dark' ? grey[100] : '#0d013a'};
  border-radius: 8px;
  ...
  padding: 0.75rem;
  color: ${theme.palette.mode === 'dark' ? grey[50] : grey[200]};
  font-family: 'IBM Plex Sans', sans-serif;
  font-weight: 500;
  text-align: start;
  position: relative;
  ...
  & .snackbar-close-icon {
    ...
    &:hover {
      background: ${theme.palette.mode === 'dark' ? grey[800] : grey[500]};
    }
  }
  `,
);
